...
; RUN: llc -mtriple=mipsel-unknown-linux-gnu -O0 --disable-machine-licm -mcpu=mips32 -relocation-model=pic -verify-machineinstrs < %s -rafast-ignore-missing-defs | \
...
; RUN: llc -mtriple=mipsel-unknown-linux-gnu -O0 --disable-machine-licm -mcpu=mips32r6 -relocation-model=pic -verify-machineinstrs < %s -rafast-ignore-missing-defs | \
...
; RUN: llc -mtriple=mips64-unknown-linux-gnu -O0 -mcpu=mips64r6 -relocation-model=pic -verify-machineinstrs -verify-machineinstrs < %s -rafast-ignore-missing-defs | \
...
; MIPS32R6O0-NEXT:    # kill: def $v1 killed $a1
; MIPS32R6O0-NEXT:    # kill: def $v1 killed $a0
; MIPS32R6O0-NEXT:    sw $5, 4($sp)
; MIPS32R6O0-NEXT:    lw $5, 4($sp)
; MIPS32R6O0-NEXT:    lw $3, %got(x)($2)
...
; MIPS64R6O0-NEXT:    lui $2, %hi(%neg(%gp_rel(AtomicCmpSwap32)))
; MIPS64R6O0-NEXT:    daddu $2, $2, $25
; MIPS64R6O0-NEXT:    daddiu $2, $2, %lo(%neg(%gp_rel(AtomicCmpSwap32)))
; MIPS64R6O0-NEXT:    # kill: def $a0 killed $a0 killed $a0_64
; MIPS64R6O0-NEXT:    move $3, $5
; MIPS64R6O0-NEXT:    sw $3, 12($sp)
; MIPS64R6O0-NEXT:    lw $5, 12($sp)
; MIPS64R6O0-NEXT:    ld $3, %got_disp(x)($2)
...
; MIPS32R6O0-NEXT:    # kill: def $a0 killed $v1
; MIPS32R6O0-NEXT:    addiu $4, $zero, -4
; MIPS32R6O0-NEXT:    and $4, $3, $4
; MIPS32R6O0-NEXT:    andi $3, $3, 3
; MIPS32R6O0-NEXT:    sll $9, $3, 3
...
; MIPS64R6O0-NEXT:    # kill: def $a0_64 killed $v1_64
; MIPS64R6O0-NEXT:    daddiu $4, $zero, -4
; MIPS64R6O0-NEXT:    and $4, $3, $4
; MIPS64R6O0-NEXT:    andi $3, $3, 3
; MIPS64R6O0-NEXT:    xori $3, $3, 3
...
; MIPS64R6O0-NEXT:    # kill: def $a1_64 killed $v1_64
...
; MIPS64R6O0-NEXT:    daddiu $sp, $sp, -16
; MIPS64R6O0-NEXT:    lw $1, 12($sp) # 4-byte Folded Reload
; MIPS64R6O0-NEXT:    lui $2, %hi(%neg(%gp_rel(zeroreg)))
; MIPS64R6O0-NEXT:    daddu $2, $2, $25
; MIPS64R6O0-NEXT:    daddiu $2, $2, %lo(%neg(%gp_rel(zeroreg)))
; MIPS64R6O0-NEXT:    sync
; MIPS64R6O0-NEXT:    ld $4, %got_disp(a)($2)
