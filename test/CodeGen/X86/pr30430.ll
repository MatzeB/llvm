...
; CHECK-NEXT:    vmovss {{.*#+}} xmm14 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmovss {{.*#+}} xmm13 = mem[0],zero,zero,zero
; CHECK-NEXT:    vinsertps {{.*#+}} xmm9 = xmm9[0],xmm15[0],xmm9[2,3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm9 = xmm9[0,1],xmm14[0],xmm9[3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm9 = xmm9[0,1,2],xmm13[0]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0],xmm12[0],xmm1[2,3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0,1],xmm11[0],xmm1[3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm10 = xmm1[0,1,2],xmm10[0]
; CHECK-NEXT:    # implicit-def: $ymm1
; CHECK-NEXT:    vmovaps %xmm10, %xmm1
; CHECK-NEXT:    vinsertf128 $1, %xmm9, %ymm1, %ymm1
; CHECK-NEXT:    vinsertps {{.*#+}} xmm2 = xmm2[0],xmm8[0],xmm2[2,3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm2 = xmm2[0,1],xmm7[0],xmm2[3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm2 = xmm2[0,1,2],xmm6[0]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0],xmm5[0],xmm0[2,3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1],xmm4[0],xmm0[3]
