...
; CHECK-NEXT:    vmovaps 208(%rbp), %ymm2
...
; CHECK-NEXT:    vpblendd {{.*#+}} ymm3 = ymm6[0,1,2,3,4,5],ymm3[6,7]
; CHECK-NEXT:    vmovaps %xmm2, %xmm8
; CHECK-NEXT:    vmovdqa %xmm8, %xmm2
; CHECK-NEXT:    vmovaps %xmm2, %xmm4
; CHECK-NEXT:    vxorps %xmm2, %xmm2, %xmm2
; CHECK-NEXT:    # implicit-def: $ymm6
; CHECK-NEXT:    vinserti128 $1, %xmm8, %ymm6, %ymm6
...
; CHECK-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm6[4,5],ymm0[6,7]
; CHECK-NEXT:    vmovaps %xmm3, %xmm6
; CHECK-NEXT:    # implicit-def: $ymm3
; CHECK-NEXT:    vinserti128 $1, %xmm6, %ymm3, %ymm3
; CHECK-NEXT:    vpblendd {{.*#+}} ymm2 = ymm7[0,1],ymm2[2,3],ymm7[4,5],ymm2[6,7]
; CHECK-NEXT:    vpermq {{.*#+}} ymm2 = ymm2[2,1,2,3]
; CHECK-NEXT:    vpblendd {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm3[4,5,6,7]
